          ...
          >
            <div className="flex flex-col border-r bg-gray-900 p-6 dark:border-gray-800 dark:bg-gray-900">
              <div className="mb-6 flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold text-gray-50">Watch Later</h2>
              </div>
              <nav className="flex flex-col gap-2">
                ...
                >
                  <Button className={" text-sm font-medium text-gray-950 bg-gray-400 hover:bg-gray-300 transition-colors dark:bg-gray-600 dark:hover:bg-gray-700 dark:text-gray-100"}>
